...
!function(t, e) {
    ...
    s = function() {
        ...
        t.SoundFile = function(e, i, n, o) {
            ...
            var r,
                ...
                c = t || 0;
            if (0 > c && (c = 0), c += u, "undefined" != typeof e && this.rate(e), "undefined" != typeof i && this.setVolume(i), !this.buffer)
        ...
        t.Amplitude = function(t) {
            ...
            for (var e = 0; e < t.inputBuffer.numberOfChannels; e++) {
                for (var i, n = t.inputBuffer.getChannelData(e), o = n.length, r = 0, s = 0, a = 0; o > a; a++)
                    i = n[a], this.normalize ? (r += Math.max(Math.min(i / this.volMax, 1), -1), s += Math.max(Math.min(i / this.volMax, 1), -1) * Math.max(Math.min(i / this.volMax, 1), -1)) : (r += i, s += i * i);
                var u = r / o,
                    c = Math.sqrt(s / o);
    ...
    u = function() {
        ...
        t.FFT = function(t, i) {
            ...
            for (var e, i, n, o = 0; o < arguments.length; o++)
                "number" == typeof arguments[o] && (e = arguments[o], this.analyser.fftSize = 2 * e), "string" == typeof arguments[o] && (i = arguments[o]);
            if (i && !t.prototype._isSafari())
                return r(this, this.timeDomain), this.analyser.getFloatTimeDomainData(this.timeDomain), this.timeDomain;
            ...
            if (t && "db" === t.toLowerCase())
                return n(this), this.analyser.getFloatFrequencyData(this.freqDomain), this.freqDomain;
            ...
            for (var t = t || 16, e = this.freqDomain, i = e.length, n = Math.floor(i / t), o = new Array(t), r = 0, s = 0; i > s; s++)
                o[r] = void 0 !== o[r] ? (o[r] + e[s]) / 2 : e[s], s % n === n - 1 && r++;
            return o
    ...
    l = function(t) {
        return t.TimeBase = function(e, i) {
            ...
            for (var n = t.peek(); n && this._matchGroup(n, this._binaryExpressions, e);)
                n = t.next(), i = n.method.bind(this, i, this._parseBinary(t, e - 1)), n = t.peek();
            return i
    ...
    F = function() {
        ...
        a.setContext(e.audiocontext), t.Env = function(t, i, n, o, r, a) {
            ...
            for (var n = 1; n < this.mathOps.length; n++)
                this.mathOps[n].dispose()
        }
    }(i, x, S, w, O, c);
    var q;
    q = function() {
        function e() {
            for (var t = n.audiocontext, e = t.createBuffer(1, 2048, t.sampleRate), i = e.getChannelData(0), o = 0; 2048 > o; o++)
                i[o] = 1;
    ...
    V = function() {
        ...
        e.inputSources = [], t.AudioIn = function(i) {
            ...
            if (i) {
                ...
                this.output.gain.cancelScheduledValues(e.audiocontext.currentTime), this.output.gain.setValueAtTime(t, e.audiocontext.currentTime)
    ...
    z = function() {
        ...
        return t.EQ = function(t) {
            ...
            for (var n, o, r = 0; t > r; r++)
                r === t - 1 ? (n = 21e3, o = .01) : 0 === r ? (n = 100, o = .1) : 1 === r ? (n = 3 === t ? 360 * i : 360, o = 1) : (n = this.bands[r - 1].freq() * i, o = 1), this.bands[r] = this._newBand(n, o), r > 0 ? this.bands[r - 1].connect(this.bands[r].biquad) : this.input.connect(this.bands[r].biquad);
            ...
            for (e.prototype.dispose.apply(this); this.bands.length > 0;)
    ...
    $ = function() {
        ...
        t.Reverb = function() {
            ...
            for (e = 0; n > e; e++)
                t = this._reverse ? n - e : e, s[e] = (2 * Math.random() - 1) * Math.pow(1 - t / n, o), a[e] = (2 * Math.random() - 1) * Math.pow(1 - t / n, o);
    ...
    et = function() {
        ...
        t.prototype.setBPM = function(t, e) {
            o = t;
            for (var i in n.parts)
                n.parts[i] && n.parts[i].setBPM(t, e)
    ...
    it = function() {
        ...
        return t.SoundLoop = function(t, i) {
            ...
            if (t.isPlaying) {
                ...
                t.clock.start(o + n), t.isPlaying = !0, this.clock.start(o + n), this.isPlaying = !0
    ...
    ct = function() {
        ...
        t.PolySynth = function(i, o) {
            ...
            for (var t = 0; t < this.polyValue; t++)
            ...
            var s,
                a = e.audiocontext.currentTime,
                u = r || 0,
                c = a + u,
                p = "string" == typeof i ? this.AudioVoice.prototype._setNote(i) : "number" == typeof i ? i : 440,
                h = void 0 === o ? 1 : o;
            if (void 0 !== this.notes[p] && null !== this.notes[p].getValueAtTime(c) && this.noteRelease(p, 0), this._voicesInUse.getValueAtTime(c) < this.polyValue)
                s = this._voicesInUse.getValueAtTime(c);
            else {
                s = this._oldest;
            ...
            var n = "string" == typeof t ? this.AudioVoice.prototype._setNote(t) : "number" == typeof t ? t : this.audiovoices[this._newest].oscillator.freq().value,
                ...
                r = i || 0,
                s = o + r;
            if (null === this.notes[n].getValueAtTime(s))
    ...
    pt = function() {
        function e(t) {
            for (var e, i = "number" == typeof t ? t : 50, n = 44100, o = new Float32Array(n), r = Math.PI / 180, s = 0; n > s; ++s)
                e = 2 * s / n - 1, o[s] = (3 + i) * e * 20 * r / (Math.PI + i * Math.abs(e));
            return o
        }
        var i = Z;
